                ...
                <div class="m-text19 p-t-15">
                    ...
                    <table class="table table-bordered">
                        <?php foreach ($datamultilevel as $value) { ?>
                            <tr>
                                <td><?php if ($value->rangeEnd == 0) {
                                        echo "≥ " . $value->rangeStart . " " . $value->unit;
                                    } else {
                                        echo $value->rangeStart . " - " . $value->rangeEnd . " " . $value->unit;
                                    } ?></td>
            ...
            <div class="p-t-5 p-b-10">
                <div class="flex-m flex-w p-b-10">
                    ...
                    <div class="btn-addcart-product-detail col-md-6 size25 trans-0-4 m-t-10 m-b-1">
                        <button data-weight="<?php echo $productdetail->productWeight; ?>" data-idproduct="<?php echo $productdetail->idp; ?>" data-image="<?php echo $productdetail->fotoName; ?>" data-productname="<?php echo $productdetail->productName; ?>" data-price="<?php
