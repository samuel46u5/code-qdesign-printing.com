...
<script>
    ...
    $(document).ready(function () {
        ...
        {
            var outputnull = '<div class="alert alert-info col-md-12 text-center"><small>Tidak ada Data untuk di tampilkan lagi</small></div>';
            $.ajax({
                ...
                success: function (data)
                {
                    if (data == 0)
                    {
                        $('#load_data_message').html(outputnull);
                        action = 'active';
                    } else
                    {
