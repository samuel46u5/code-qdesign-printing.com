                    ...
                    <div class="card-body p-0 bo17">
                        ...
                        <div class="row pb-5 p-4">
                            <div class="col-md-6">
                                ...
                                <p>Alamat : <br>
                                    <!-- <?php echo $user->kabupaten . ", " . $user->provinsi; ?> -->
                                    <?php echo $user->fullAddress . ", " . $user->desa . ", " . $user->rt . "-" . $user->rw . ", " . $user->kecamatan . ", " . $user->namaKabupaten . ", " . $user->namaProvinsi . ", " . $user->kodePos; ?>
                                </p>
                ...
                <div class="card">
                    <div class="card-body p-0 bo17">
                        <div class="col-md-12">
                            ...
                            <div class="p-2">
                                <?php
                                if ($invoice->invoicePartnerStatus == "PAID") { } else {
                                    ?>
