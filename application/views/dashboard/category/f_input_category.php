                        ...
                        <div class="col-lg-12">
                            <form role="form" class="form-horizontal" id="inputcategory">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="textarea form-control" rows="7" name="categorydesc" id="categorydesc" required=""></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="metatagtitle" id="metatagtitle" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" rows="5" name="metatagdesc" id="metatagdesc" required=""></textarea>
                                    </div>
                                </div>
                                 <div class="form-group">
                                ...
                                <input type="button" onclick="storeCategory();" class="btn btn-success pull-right" value="Simpan">
...
<script type="text/javascript">
    function storeCategory() {
        ...
        $('#loader').show();
        $.ajax({
            url: '<?php echo base_url('d/Category/store_category') ?>',
            method: "POST",
