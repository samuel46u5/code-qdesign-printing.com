                ...
                <div class="panel-body">
                    <form role="form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formemail">
                        ...
                        <div class="form-group" id="cc">
                            <label>CC.</label>
                            <input class="form-control" name="cc" id="cc" name="cc">
                        </div>
                        <div class="form-group">
                            <label>Judul</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="wysiwyg" class="textarea required form-control" rows="7" name="pesan" id="pesan" required>Halo kak <?php echo $data->email."<br> Anda menambahkan ".$data->productName." kedalam wishlist Anda";?></textarea>
                        </div>
