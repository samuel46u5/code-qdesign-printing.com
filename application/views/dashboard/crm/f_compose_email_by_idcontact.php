            ...
            <div class="panel panel-green">
                <div class="panel-body">
                    <form role="form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formemail">
                        ...
                        <div class="form-group">
                            <label>Judul</label>
                            <input type="text" class="form-control" placeholder="Enter text" required="" value="Terkait pesan Anda Tanggal <?php echo $data->date_create;?>">
                        </div>
                        <div class="form-group">
                            <label for="">Pesan</label>
                            <textarea id="wysiwyg" class="textarea required form-control" rows="7" name="pesan" id="pesan" required><?php echo $data->message; ?></textarea>
                        </div>
