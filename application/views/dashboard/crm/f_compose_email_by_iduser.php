<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Kirim E-mail ke <?php echo $data->username; ?>
        </h3>
        <div class="row">
                ...
                <div class="panel-body">
                    <form role="form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formemail">
                        <div class="form-group">
                            <label>Kepada</label>
                            <input class="form-control" name="email" id="email" type="email" required="" value="<?php echo $data->useremail; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="wysiwyg" class="textarea required form-control" rows="7" name="pesan" id="pesan" required>Halo kak <?php echo $data->username; ?></textarea>
                        </div>
