<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Kirim E-mail
        </h3>
        <div class="row">
            <div class="panel panel-green">
                <div class="panel-body">
                    <form role="form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" id="formemail">
                        ...
                        <div class="form-group">
                            <label>Judul</label>
                            <input class="form-control" placeholder="Enter text" id="title" name="title" required="">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function autocomplete(){
       $( "#email" ).autocomplete({
          source: "<?php echo site_url('d/Crm/get_autocomplete_email/?');?>"
      });
   }
